...
export const action = async ({ request }: ActionFunctionArgs) => {
    try {
        ...
        console.log("=== CHECKOUTS/CREATE WEBHOOK RECEIVED ===");
        ...
        console.log(
            `Saved checkout create event ${checkoutPayload.token ?? checkoutPayload.id} to CheckoutEvent`,
        );

        return new Response("OK", { status: 200 });
    } catch (error) {
        console.error("checkouts/create webhook failed:", error);
